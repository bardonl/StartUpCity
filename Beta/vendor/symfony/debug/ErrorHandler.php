...
class ErrorHandler
{
    private $levels = array(
        ...
        E_USER_ERROR => 'User ErrorRequest',
        E_RECOVERABLE_ERROR => 'Catchable Fatal ErrorRequest',
        E_COMPILE_ERROR => 'Compile ErrorRequest',
        E_PARSE => 'Parse ErrorRequest',
        E_ERROR => 'Error',
        E_CORE_ERROR => 'Core ErrorRequest',
    );
     ...
     *
     * @param array $loggers ErrorRequest levels to [LoggerInterface|null, LogLevel::*] map
     *
