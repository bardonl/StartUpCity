...
<div class="overlay overlay_signup">
    ...
    <h3>Aanmelden</h3>
    <a href="/social/facebook" class="button button_facebook"><img
                src="{{ asset('css/gfx/facebook_icon.png') }}">Aanmelden met Facebook</a>
    <a href="/social/google" class="button button_google"><img src="{{ asset('css/gfx/google_icon.png') }}">Aanmelden met
        Google</a>
    <div class="of">
        <span>of</span>
    </div>
...
<div class="overlay overlay_signin">
    ...
    <a href="/social/google" class="button button_google"><img src="{{ asset('css/gfx/google_icon.png') }}">Inloggen met
        Google</a>
    <div class="of">
        <span>of</span>
    </div>
