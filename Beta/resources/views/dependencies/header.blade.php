...
<div class="mo-timer pull-right">
    ...
    <input id="assignment-start-time" type="hidden" value="[=assignment_start_time]" />
    <input id="assignment-duration" type="hidden" value="[=assignment_duration_time]" />
    <input id="assignment-peanuts" type="hidden" value="[=assignment_peanuts]" />
</div>