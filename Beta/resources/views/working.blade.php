            ...
            <div class='co-panel'>
                ...
                <div class='co-actionbar col-xs-12'>
                    ...
                    <div class='co-actionbar__button--right'>
                        <a href='/working/start-assignment/{{$assignment->id}}' class='mo-button mo-button__secondary @if($assignments->disabled === 1) assignment-start-button-disabled @endif '>start <i class='mo-icon-font mo-icon-font__start'></i></a>
                    </div>
                </div>
            </div>
        </div>
